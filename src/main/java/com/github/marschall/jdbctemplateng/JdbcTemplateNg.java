...
public final class JdbcTemplateNg {
  ...
  public UpdateUnboundStatementProcessor update(PreparedStatementCreator preparedStatementCreator) {
    return new UpdateUnboundStatementProcessor(this.dataSource, preparedStatementCreator);
  }
  ...
  public BatchUnboundStatementProcessor batchUpdate(PreparedStatementCreator preparedStatementCreator) {
    return new BatchUnboundStatementProcessor(this.dataSource, preparedStatementCreator);
  }
